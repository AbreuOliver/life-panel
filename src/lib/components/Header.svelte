...
<header
  class={`flex justify-center items-center text-center py-2 h-full min-h-[56px] sticky top-0 z-10 w-full px-6 ${
    pwaIOS ? "pwa-ios" : "default-header"
  }`}
>
  <h1
    class={`flex justify-center align-items max-w-[45ch] mx-auto w-full font-manrope text-4xl font-bold tracking-tight ${
